...
public class DeleteMenu extends JFrame {
	...
	public void buildButtonPanel() {
		...
		cancelButton = new JButton("Cancel Deletion");

		// Register the action listeners
		deleteButton.addActionListener(new DeleteMenu.deleteAppointmentButtonListener());
		cancelButton.addActionListener(new DeleteMenu.CancelChangesButtonListener());
        ...
        public class deleteAppointmentButtonListener implements ActionListener{
            public void actionPerformed(ActionEvent e)
            {
//                file.delete();
            }
